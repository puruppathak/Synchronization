...
// Name: Puru P Pathak
// Multithreading program using synchronization.
...
typedef struct Pair_struct{                  //structure used to find a key value pair
	char *key;
	char *value;
}Pair_variable;

typedef struct A_Array_struct{                //Associative array structure here
	int count;
	Pair_variable *pairs;
}A_Array;

typedef struct Dict_struct{                   //Dictionary structure declared here
    int count;
	A_Array *A_arrays;
}Dict;
